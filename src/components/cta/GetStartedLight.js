...
const PrimaryBackgroundContainer = tw.div`py-16 lg:py-20 bg-primary-300 rounded-lg relative`
...
const PrimaryLink = tw(Link)`shadow text-gray-lightest hocus:text-gray-300 bg-primary-500 hocus:bg-primary-700`;

const SecondaryLink = tw(Link)`text-primary-500 hover:text-primary-700 bg-gray-100 hover:bg-gray-200`;
