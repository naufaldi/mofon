...
export default ({
  subheading = "Silabus dan Mentor",
  heading = (
    <>
      Mentor  <span tw="text-primary-500">Berpengalaman.</span>
    </>
  ),
  ...
  primaryButtonUrl = "http://bit.ly/silabus-mofon",
  ...
  const defaultFeatures = [
    {
      Icon: BriefcaseIcon,
      title: "Profesional",
      description: "Pengajar seorang Frontend Development yang berpengalaman di industri selama 2 tahun.",
      iconContainerCss: tw`bg-teal-300 text-teal-800`
    },
    {
      Icon: MoneyIcon,
      title: "Kurikulum Dasar",
      description: "Kurikulum, materi dibuat untuk orang awam hingga mampu untuk membangun sebuah website, mengkonversi dari desain kedalam website",
