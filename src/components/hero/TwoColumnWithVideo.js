...
export default ({
  ...
  description = 'Mari Belajar Frontend Website mulai dari HTML, CSS dan SASS untuk menunjang impianmu menjadi seorang Frontend Website. Pelaksanaan Batch 5, 15 Maret 2021',
